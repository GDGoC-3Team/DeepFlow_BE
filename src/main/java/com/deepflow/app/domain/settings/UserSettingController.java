...
public class UserSettingController {
    ...
    @Operation(summary = "사용자 설정 조회", description = "고정 사용자(id=1)의 설정을 조회합니다.", tags = {"일반 설정"})
    @ApiResponses({
    ...
    @Operation(summary = "알림 수신 여부 조회", description = "고정 사용자(id=1)의 알림 수신 여부를 조회합니다.", tags = {"알림"})
    ...
    @Operation(summary = "알림 수신 여부 변경", description = "고정 사용자(id=1)의 알림 수신 여부를 변경합니다.", tags = {"알림"})
    ...
    @Operation(summary = "글꼴 조회", description = "고정 사용자(id=1)의 글꼴 설정을 조회합니다.", tags = {"일반 설정"})
    ...
    @Operation(summary = "글꼴 변경", description = "고정 사용자(id=1)의 글꼴 설정을 변경합니다.", tags = {"일반 설정"})
    ...
    @Operation(summary = "글자 크기 조회", description = "고정 사용자(id=1)의 글자 크기 설정을 조회합니다.", tags = {"일반 설정"})
    ...
    @Operation(summary = "글자 크기 변경", description = "고정 사용자(id=1)의 글자 크기 설정을 변경합니다.", tags = {"일반 설정"})
    ...
    @Operation(summary = "알림 시간 조회", description = "고정 사용자(id=1)의 알림 시간을 조회합니다.", tags = {"알림"})
    ...
    @Operation(summary = "알림 시간 변경", description = "고정 사용자(id=1)의 알림 시간을 변경합니다.", tags = {"알림"})
    ...
    @Operation(summary = "알림 토큰 등록 여부 조회", description = "고정 사용자(id=1)의 알림 토큰 등록 여부를 조회합니다.", tags = {"알림"})
    ...
    @Operation(summary = "알림 토큰 등록 또는 변경", description = "고정 사용자(id=1)의 알림 토큰을 등록하거나 변경합니다.", tags = {"알림"})
    ...
    @Operation(summary = "알림 토큰 삭제", description = "고정 사용자(id=1)의 알림 토큰을 삭제합니다.", tags = {"알림"})
